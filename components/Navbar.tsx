   ...
   >
    ...
    <div className="flex flex-col h-full w-full max-w-[380px] mx-8 sm:mx-auto px-1">
     <div className="grow flex flex-col justify-center gap-12 sm:gap-14">
        ...
        {MENU_LINKS.map((link, idx) => (
         ...
         >
          <button
           ...
           style={{
            transitionDelay: isMenuOpen ? `${150 + idx * 60}ms` : '0ms',
           }}
           className={cn(
      ...
      <div>
       <p className="text-xs font-medium text-muted-foreground tracking-[0.3em] mb-5">
        SOCIAL
       </p>
         ...
         return (
          <li key={link.name}>
           <a
            ...
            style={{
             transitionDelay: isMenuOpen ? `${380 + idx * 60}ms` : '0ms',
            }}
            className={cn(
     ...
     <div className="pt-8">
      <p className="text-xs font-medium text-muted-foreground tracking-[0.3em] mb-3">
       GET IN TOUCH
      </p>
      <a
