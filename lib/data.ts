...
export const SOCIAL_LINKS = [
 ...
 {
  name: 'linkedin',
  url: 'https://www.linkedin.com/in/ansari-rashid-a52305278',
 },
 { name: 'x', url: 'https://x.com/Rashid_DevFX' },
];

type StackItem = { name: string; icon: string; invert?: boolean };
...
export const MY_STACK: Record<string, StackItem[]> = {
 ...
 genai: [
  ...
  //   {
  //    name: 'Vector DB',
  //    icon: 'https://cdn.simpleicons.org/qdrant/FFFFFF',
  //   },
  //   {
  //    name: 'Gen AI',
...
export const PROJECTS: IProject[] = [
 ...
 },
 {
  ...
  sourceCode: 'https://github.com/Rashid004/crenotive',
 ...
 },
 {
  ...
  sourceCode: 'https://github.com/Rashid004/devsLink',
